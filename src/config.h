...
enum {
  ...
  G_TOKEN_ITEM = G_TOKEN_LAST + 150,
  G_TOKEN_SEPARATOR = G_TOKEN_LAST + 151,
  G_TOKEN_SUBMENU = G_TOKEN_LAST + 152,
  G_TOKEN_REGEX = G_TOKEN_LAST + 160 + VP_REGEX,
  G_TOKEN_JSON = G_TOKEN_LAST + 160 + VP_JSON,
  G_TOKEN_GRAB = G_TOKEN_LAST + 160 + VP_GRAB
};

...
enum {
  ...
  G_TOKEN_FUNCTION = G_TOKEN_LAST + 151,
  G_TOKEN_MAXIMIZE = G_TOKEN_LAST + 152,
  G_TOKEN_MINIMIZE = G_TOKEN_LAST + 153,
  G_TOKEN_UNMAXIMIZE = G_TOKEN_LAST + 154,
  G_TOKEN_UNMINIMIZE = G_TOKEN_LAST + 155,
  G_TOKEN_FOCUS = G_TOKEN_LAST + 156,
  G_TOKEN_CLOSE = G_TOKEN_LAST + 157,

...
/* API */
static void
api_set_workspace(workspace_t *sfwbar_ws)
{
...
static void
workspace_handle_remove(void *data,
		struct zcosmic_workspace_handle_v1 *workspace)
{
...
static void
workspace_group_handle_workspace(void *data,
		struct zcosmic_workspace_group_handle_v1 *workspace_group,
		struct zcosmic_workspace_handle_v1 *workspace)
{
...
static void
workspace_group_handle_remove(void *data,
		struct zcosmic_workspace_group_handle_v1 *workspace_group)
{
...
/* Public API */
void
cosmic_workspaces_register(struct wl_registry *registry,
		uint32_t global, uint32_t version)
{
	...
	zcosmic_workspace_manager_v1_add_listener(
		workspace_manager, &workspace_manager_impl, NULL);
}
